        ...
        methods: {
            ...
            signAndPost(evt) {
                ...
                signClearText(
                    ...
                    .then(signatureKey =>
                        createPost(this.form.postContent, signatureKey).then(() => {
                    ...
                    this.$swal
                        .fire({
                            title: 'Confirmation',
                            text: 'Something went wrong while creating the post signature. Creating the post without ' +
                        ...
                        .then(result => {
                            if (result.value) {
                                createPost(this.form.postContent, null).then(() => {
                                    this.displayConfirmation();
                                }).catch(() => {
                                    this.displayError();
                                });
